...
$objPHPExcel->getProperties()->setCreator("新云网讯网络科技有限公司")
							 ...
							 ->setTitle("Office 2007 XLSX 现场活动大屏幕系统猴子爬树结果")
							 ->setSubject("Office 2007 XLSX 现场活动大屏幕系统猴子爬树结果")
							 ->setDescription("现场活动大屏幕系统猴子爬树结果.")
							 ->setKeywords("现场活动大屏幕系统猴子爬树结果")
