// 纯JS省市区三级联动
var address3 = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea,num=0)
{
	...
	function changeCity()
	{
		...
		{
      if(num == 0 && item.areaList[0] != '请选择地区'){
         item.areaList.unshift('请选择地区');
      }
	...
	function changeProvince()
	{
		...
		{
      if(num == 0 && item.cityList[0].name != '请选择市'){
        item.cityList.unshift({name:'请选择市',areaList:[]});
      }
...
var provinceOriginal = [
	{
        ...
        "name": "河北省","cityList": [
            {"name": "石家庄市","areaList": ["长安区","桥西区","新华区","井陉矿区","裕华区","藁城区","鹿泉区","栾城区","井陉县","正定县","行唐县","灵寿县","高邑县","深泽县","赞皇县","无极县","平山县","元氏县","赵县","晋州市","新乐市"]},
            ...
            {"name": "保定市","areaList": ["竞秀区","莲池区","满城区","清苑区","徐水区","涞水县","阜平县","定兴县","唐县","高阳县","涞源县","望都县","易县","曲阳县","蠡县","顺平县","博野县","涿州市","安国市","高碑店市"]},
            {"name": "雄安新区","areaList": ["安新县","雄县","容城县"]},
            ...
            {"name": "省直辖县级行政区划","areaList": ["定州市","辛集市"]}
        ]
    },{
        "name": "山西省","cityList": [
        ...
        "name": "上海市","cityList": [
            {"name": "上海市","areaList": ["黄浦区","徐汇区","长宁区","静安区","普陀区","虹口区","杨浦区","闵行区","宝山区","嘉定区","浦东新区","金山区","松江区","青浦区","奉贤区","崇明区"]}
        ]
    },{
        "name": "江苏省","cityList": [
        ...
        "name": "浙江省","cityList": [
            {"name": "杭州市","areaList": ["上城区","拱墅区","西湖区","滨江区","萧山区","余杭区","临平区","钱塘区","富阳区","临安区","桐庐县","淳安县","建德市"]},
        ...
        "name": "江西省","cityList": [
            {"name": "南昌市","areaList": ["东湖区","西湖区","青云谱区","湾里区","青山湖区","新建区","红谷滩区","南昌县","安义县","进贤县"]},
        ...
        "name": "河南省","cityList": [
            ...
            {"name": "开封市","areaList": ["龙亭区","顺河回族区","鼓楼区","禹王台区","金明区","祥符区","杞县","通许县","尉氏县","兰考县"]},
            ...
            {"name": "新乡市","areaList": ["红旗区","卫滨区","凤泉区","牧野区","新乡县","获嘉县","原阳县","延津县","封丘县","长垣市","卫辉市","辉县市"]},
        ...
        "name": "湖南省","cityList": [
            {"name": "长沙市","areaList": ["芙蓉区","天心区","岳麓区","开福区","雨花区","望城区","长沙县","宁乡市","浏阳市"]},
        ...
        "name": "广东省","cityList": [
            ...
            {"name": "东莞市","areaList": ["东城街道","南城街道","万江街道","莞城街道","石碣镇","石龙镇","茶山镇","石排镇","企石镇","横沥镇","桥头镇","谢岗镇","东坑镇","常平镇","寮步镇","樟木头镇","大朗镇","黄江镇","清溪镇","塘厦镇","凤岗镇","大岭山镇","长安镇","虎门镇","厚街镇","沙田镇","道滘镇","洪梅镇","麻涌镇","望牛墩镇","中堂镇","高埗镇","松山湖","东莞港","东莞生态园"]},
            {"name": "中山市","areaList": ["石岐街道","东区街道","中山港街道","西区街道","南区街道","五桂山街道","小榄镇","黄圃镇","民众镇","东凤镇","东升镇","古镇镇","沙溪镇","坦洲镇","港口镇","三角镇","横栏镇","南头镇","阜沙镇","南朗镇","三乡镇","板芙镇","大涌镇","神湾镇"]},
        ...
        "name": "广西壮族自治区","cityList": [
            ...
            {"name": "桂林市","areaList": ["秀峰区","叠彩区","象山区","七星区","雁山区","临桂区","阳朔县","灵川县","全州县","兴安县","永福县","灌阳县","龙胜各族自治县","资源县","平乐县","荔浦县","恭城瑶族自治县"]},
        ...
        "name": "海南省","cityList": [
            ...
            {"name": "儋州市","areaList": ["那大镇","合庆镇","南丰镇","大成镇","雅星镇","兰洋镇","光村镇","木棠镇","海头镇","峨蔓镇","王五镇","白马井镇","中和镇","排浦镇","东成镇","新州镇","洋浦经济开发区","华南热作学院"]},
            {"name": "五指山市","areaList": []},
            {"name": "琼海市","areaList": []},
            {"name": "万宁市","areaList": []},
            {"name": "东方市","areaList": []},
        ...
        "name": "重庆市","cityList": [
            {"name": "重庆市","areaList": ["万州区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","綦江区","大足区","渝北区","巴南区","黔江区","长寿区","江津区","合川区","永川区","南川区","璧山区","铜梁区","潼南区","荣昌区","开州区"]},
            {"name": "县","areaList": ["梁平县","城口县","丰都县","垫江县","武隆县","忠县","云阳县","奉节县","巫山县","巫溪县","石柱土家族自治县","秀山土家族苗族自治县","酉阳土家族苗族自治县","彭水苗族土家族自治县"]}
        ]
    },{
        "name": "四川省","cityList": [
            {"name": "成都市","areaList": ["锦江区","青羊区","金牛区","武侯区","成华区","龙泉驿区","青白江区","新都区","温江区","双流区","金堂县","郫都区","大邑县","蒲江县","新津县","都江堰市","彭州市","邛崃市","崇州市","简阳市"]},
        ...
        "name": "贵州省","cityList": [
            ...
            {"name": "毕节市","areaList": ["七星关区","大方县","黔西市","金沙县","织金县","纳雍县","威宁彝族回族苗族自治县","赫章县"]},
        ...
        "name": "云南省","cityList": [
            {"name": "昆明市","areaList": ["五华区","盘龙区","官渡区","西山区","东川区","呈贡区","晋宁县","富民县","宜良县","石林彝族自治县","嵩明县","禄劝彝族苗族自治县","寻甸回族彝族自治县","安宁市"]},
        ...
        "name": "西藏自治区","cityList": [
            {"name": "拉萨市","areaList": ["城关区","堆龙德庆区","林周县","当雄县","尼木县","曲水县","达孜县","墨竹工卡县"]},
        ...
        "name": "陕西省","cityList": [
            ...
            {"name": "咸阳市","areaList": ["秦都区","杨陵区","渭城区","三原县","泾阳县","乾县","礼泉县","永寿县","彬县","长武县","旬邑县","淳化县","武功县","兴平市"]},
            {"name": "渭南市","areaList": ["临渭区","华州区","潼关县","大荔县","合阳县","澄城县","蒲城县","白水县","富平县","韩城市","华阴市"]},
            {"name": "延安市","areaList": ["宝塔区","安塞区","延长县","延川县","子长县","志丹县","吴起县","甘泉县","富县","洛川县","宜川县","黄龙县","黄陵县"]},
            {"name": "汉中市","areaList": ["汉台区","南郑县","城固县","洋县","西乡县","勉县","宁强县","略阳县","镇巴县","留坝县","佛坪县"]},
            {"name": "榆林市","areaList": ["榆阳区","横山区","神木县","府谷县","靖边县","定边县","绥德县","米脂县","佳县","吴堡县","清涧县","子洲县"]},
        ...
        "name": "新疆维吾尔自治区","cityList": [
            ...
            {"name": "自治区直辖县级行政区划","areaList": ["石河子市","阿拉尔市","图木舒克市","五家渠市","铁门关市"]}
        ]
    },{ 
				"name": "台湾省", "cityList":[
						...
						{"name":"基隆市", "areaList":["基隆市"]},
						{"name":"新竹市", "areaList":["新竹市"]},
						{"name":"嘉义市", "areaList":["嘉义市"]},
						{"name":"新北市", "areaList":["新北市"]},
						{"name":"宜兰县", "areaList":["宜兰县"]},
						{"name":"新竹县", "areaList":["新竹县"]},
						{"name":"桃园市", "areaList":["桃园市"]},
						{"name":"苗栗县", "areaList":["苗栗县"]},
						{"name":"彰化县", "areaList":["彰化县"]},
						{"name":"嘉义县", "areaList":["嘉义县"]},
						{"name":"云林县", "areaList":["云林县"]},
						{"name":"屏东县", "areaList":["屏东县"]},
						{"name":"台东县", "areaList":["台东县"]},
						{"name":"花莲县", "areaList":["花莲县"]},
						{"name":"澎湖县", "areaList":["澎湖县"]}
				]
		},{
				"name": "香港特别行政区", "cityList":[
					{"name":"香港特别行政区", "areaList":["中西区","湾仔区","东区","南区","深水埗区","油尖旺区","九龙城区","黄大仙区","观塘区","北区","大埔区","沙田区","西贡区","元朗区","屯门区","荃湾区","葵青区","离岛区","其他"]}
				]
		},{
				"name": "澳门特别行政区", "cityList":[
						{"name":"澳门特别行政区", "areaList":["花地玛堂区","圣安多尼堂区","大堂区","望德堂区","风顺堂区","嘉模堂区","圣方济各堂区","路凼","其他"]}
				]
		}
]
//重新赋值，防止原数据被格式化，取不到格式化前的数据
var provinceList = JSON.parse(JSON.stringify(provinceOriginal));