...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($username == 'admin' && $password == 'admin123456') {
        ...
        echo json_encode(['code' => 1, 'msg' => '登录成功', 'url' => '/sysadmin_dashboard_direct.php']);
    } else {
    ...
    if (isset($_SESSION['sysadmin_admin_id'])) {
        header('Location: /sysadmin_dashboard_direct.php');
        exit;
    }
...
<body>
    <div class="login-container">
        ...
        <form action="/sysadmin_login_direct.php" method="post" onsubmit="return submitForm();">
            <div class="form-item">
    ...
    <script>
        function submitForm() {
            ...
            fetch('/sysadmin_login_direct.php', {
                method: 'POST',
                body: formData
            })
