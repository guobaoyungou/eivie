...
class TuangouPoster extends Common
{
	...
	public function index(){
		...
		$posterset = Db::name('admin_set_poster')->where('aid',aid)->where('type','tuangou')->where('platform',$type)->order('id')->find();
		if(!$posterset){
			...
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'mp','content'=>$data_product_mp]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'wx','content'=>$data_product_wx]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'alipay','content'=>$data_product_mp]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'baidu','content'=>$data_product_mp]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'toutiao','content'=>$data_product_mp]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'qq','content'=>$data_product_mp]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'h5','content'=>$data_product_mp]);
			Db::name('admin_set_poster')->insert(['aid'=>aid,'type'=>'tuangou','platform'=>'app','content'=>$data_product_mp]);
	...
	public function save(){
		$type = input('param.type') ? input('param.type') : $this->platform[0];
		$field = input('param.field') ? input('param.field') : 'tuangou';
		...
		\app\common\System::plog('编辑团购分享海报');
