...
class PhotoSceneGroup extends Common
{
    ...
    public function edit()
    {
        ...
        return View::fetch('photo_scene_group/edit');
    }
    ...
    public function save()
    {
        ...
        if ($info['id']) {
            ...
            \app\common\System::plog('编辑照片场景分组' . $info['id']);
        } else {
            // 新增
            $info['aid'] = aid;
            $info['bid'] = bid;
            ...
            \app\common\System::plog('添加照片场景分组' . $id);
        }
    ...
    public function del()
    {
        ...
        \app\common\System::plog('删除照片场景分组' . implode(',', $ids));
    ...
    public function choosegroup()
    {
        ...
        return View::fetch('photo_scene_group/choosegroup');
    }
}
