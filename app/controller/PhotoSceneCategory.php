...
class PhotoSceneCategory extends Common
{
    ...
    public function edit()
    {
        ...
        return View::fetch('photo_scene_category/edit');
    }
    ...
    public function save()
    {
        ...
        if ($info['id']) {
            ...
            \app\common\System::plog('编辑照片场景分类' . $info['id']);
        } else {
            // 新增
            $info['aid'] = aid;
            $info['bid'] = bid;
            ...
            \app\common\System::plog('添加照片场景分类' . $id);
        }
    ...
    public function del()
    {
        ...
        \app\common\System::plog('删除照片场景分类' . implode(',', $ids));
    ...
    public function choosecategory()
    {
        ...
        return View::fetch('photo_scene_category/choosecategory');
    }
}
