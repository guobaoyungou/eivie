<?php
echo 'Sysadmin login direct access!';
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $username = $_POST['username'] ?? '';
    $password = $_POST['password'] ?? '';
    
    if ($username == 'admin' && $password == 'admin123456') {
        echo json_encode(['code' => 1, 'msg' => '登录成功', 'url' => '/sysadmin/dashboard']);
    } else {
...
<body>
    <div class="login-container">
        ...
        <form action="/sysadmin_login.php" method="post" onsubmit="return submitForm();">
            <div class="form-item">
