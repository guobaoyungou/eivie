<?php /*a:4:{s:46:"/www/wwwroot/eivie/app/view/member/charts.html";i:1755845274;s:43:"/www/wwwroot/eivie/app/view/public/css.html";i:1764308967;s:42:"/www/wwwroot/eivie/app/view/public/js.html";i:1766974798;s:49:"/www/wwwroot/eivie/app/view/public/copyright.html";i:1648714895;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title><?php echo t('会员'); ?>关系图</title>
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header"><?php echo t('会员'); ?>关系图
          ...
          <div class="layui-card-body" pad15>
						<div class="layui-form layui-col-md9">
							<div class="layui-inline layuiadmin-input-useradmin">
								<label class="layui-form-label" style="width:60px"><?php echo t('会员'); ?>ID：</label>
								<div class="layui-input-block" style="width:140px;margin-left:90px">
									<input type="text" name="mid" value="<?php echo app('request')->param('mid'); ?>" autocomplete="off" class="layui-input" placeholder="输入<?php echo t('会员'); ?>ID查看">
								</div>
							</div>
							<div class="layui-inline">
								<button class="layui-btn layui-btn-primary" lay-submit="" lay-filter="LAY-app-forumreply-search">查看</button><?php if($member['pid']): ?><button class="layui-btn layui-btn-primary layuiadmin-btn-list" onclick="location.href='<?php echo url('charts'); ?>/mid/<?php echo $member['pid']; if(input('param.isopen')==1): ?>/isopen/1<?php endif; ?>'">上一层</button><?php endif; if($deeplevel >= 10): ?><button class="layui-btn layui-btn-primary layuiadmin-btn-list" id="jiazaimore">加载更多</button><?php endif; ?>
							</div>
						</div>
						<div class="layui-col-md12" id="guanxitu" style="height:<?php if($deeplevel > 4): ?><?php echo $deeplevel*150; ?>px<?php else: ?>600px<?php endif; ?>">
...
<script>
	...
	<script src="/static/admin/js/echarts5.5.1.min.js?v=1109"></script>
	<script>
	layui.form.on('submit(LAY-app-forumreply-search)', function(obj){
		var field = obj.field
		location.href = "<?php echo url('charts'); ?>/mid/" + field.mid + "<?php if(input('param.isopen')==1): ?>/isopen/1<?php endif; ?>";
	})
	<?php if($member): ?>
	...
	var option = {
			...
			series:[
					{
							type: 'tree',
							data: [<?php echo jsonEncode($member); ?>],
							left: '2%',
							merge:true,
							right: '2%',
							top: '8%',
	...
	$("#jiazaimore").click(function(){
		...
		appendNewDataToBottom(<?php echo jsonEncode($member,true); ?>);  
	})
