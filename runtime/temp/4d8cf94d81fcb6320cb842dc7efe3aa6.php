<?php /*a:4:{s:45:"/www/wwwroot/eivie/app/view/hexiao/index.html";i:1755845268;s:43:"/www/wwwroot/eivie/app/view/public/css.html";i:1764308967;s:42:"/www/wwwroot/eivie/app/view/public/js.html";i:1766974798;s:49:"/www/wwwroot/eivie/app/view/public/copyright.html";i:1648714895;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header"><i class="fa fa-list"></i> 核销记录
          ...
          <div class="layui-card-body" pad15>
						...
						<div class="layui-form layui-col-md9 layui-form-search">
							...
							<div class="layui-inline layuiadmin-input-useradmin">
								<label class="layui-form-label">核销内容</label>
								<div class="layui-input-inline">
									<input type="text" name="title" autocomplete="off" class="layui-input" value="">
								</div>
							</div>
							<div class="layui-inline layuiadmin-input-useradmin">
								<label class="layui-form-label">核销备注</label>
								<div class="layui-input-inline">
...
<script>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
      ...
      {field: 'nickname', title: '<?php echo t('会员'); ?>信息',templet:'<div>{{# if(d.nickname){ }}<img src="{{d.headimg}}" style="width:50px"> {{d.nickname}}{{# } }}</div>',width:150},
      {field: 'typename', title: '订单类型',width:120},
      {field: 'title', title: '核销内容'},
      {field: 'md_name', title: '<?php echo t('门店'); ?>',width:140},
      {field: 'createtime', title: '核销时间',sort:true,templet:function(d){ return date('Y-m-d H:i',d.createtime)},width:150},
      ...
      {field: 'op', title: '操作',templet:function (d) {
				...
				<?php if(!getcustom('handle_auth') || ($auth_data=='all' || in_array('HexiaoDel',$auth_data))): ?>
