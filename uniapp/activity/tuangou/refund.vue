...
<view class="container">
	<form @submit="formSubmit" @reset="formReset" report-submit="true">
		...
		<button class="ref-btn" :style="{background:t('color1')}" form-type="submit">确定</button>
	</form>
    ...
    formSubmit: function (e) {
      ...
      if (money < 0 || money > parseFloat(that.totalprice)) {
        ...
        return;
			...
			app.showLoading('提交中');
      app.post('ApiTuangou/refund', {orderid: orderid,reason: reason,money: money}, function (data) {
