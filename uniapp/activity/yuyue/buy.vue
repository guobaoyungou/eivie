            ...
            <view v-if="sindex==2">
              <view class="price">
                ...
                <view  class="f2" style="overflow: hidden;line-height: 60rpx;" @tap="locationSelect" >
                  ...
                  <image src="/static/img/arrowright.png" style="width:30rpx;height:30rpx;float: right;margin-top: 16rpx;"/>
                </view>
              </view>
              <view class="price">
							...
							<block v-if="item.key=='upload'">
								...
								<view class="flex" style="flex-wrap:wrap;padding-top:20rpx">
									<view class="form-imgbox" v-if="buydata.editorFormdata[idx]">
										<view class="layui-imgbox-close" style="z-index: 2;" @tap="removeimg" :data-bid="buydata.bid" :data-idx="idx"><image style="display:block" src="/static/img/ico-del.png"></image></view>
...
<script>
	...
	export default {
      ...
      this.yydate  = app.getCache('yydate');
      ...
      if(this.opt.yydates){
        this.yydates = JSON.parse(this.opt.yydates);
							...
							if(that.yyset.yuyue_success){
								that.subscribeMessage(function () {
									app.alert(that.yyset.yuyue_success,function(){
										app.goto('/activity/yuyue/orderlist','redirect');
									});
								});
							}else{
								that.subscribeMessage(function () {
