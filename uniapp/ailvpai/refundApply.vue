...
.refund-amount-section { background: linear-gradient(135deg, #91C2FF, #B5D8FE); padding: 60rpx 30rpx; text-align: center; color: #fff; }
...
.reason-item { display: flex; justify-content: space-between; align-items: center; padding: 24rpx 20rpx; border: 1px solid #F0EDF5; border-radius: 12rpx; margin-bottom: 16rpx; font-size: 28rpx; color: #555555; }
.reason-item.active { border-color: #91C2FF; background: rgba(181,216,254,0.1); color: #91C2FF; }
.check-icon { color: #91C2FF; font-size: 32rpx; font-weight: bold; }
.textarea-wrap { position: relative; }
.reason-textarea { width: 100%; height: 200rpx; padding: 20rpx; border: 1px solid #F0EDF5; border-radius: 12rpx; font-size: 28rpx; color: #555555; box-sizing: border-box; background: #F5F0FA; }
.word-count { position: absolute; right: 20rpx; bottom: 20rpx; font-size: 24rpx; color: #999; }
.submit-section { padding: 40rpx 30rpx; }
.btn-submit { height: 96rpx; line-height: 96rpx; text-align: center; background: linear-gradient(135deg, #91C2FF, #B5D8FE); color: #fff; font-size: 32rpx; font-weight: bold; border-radius: 40rpx; box-shadow: 0 8rpx 24rpx rgba(145,194,255,0.3); }
