  ...
  onLoad: function (opt) {
	...
	methods: {
		...
		addfavorite: function () {
			...
			app.post('ApiHuodongBaoming/addfavorite', {proid: proid,type: 'huodongbaoming'}, function (data) {
				if (data.status == 1) {
...
.cuxiaopoint .f2{flex-shrink:0;display:flex;align-items:center;width:32rpx;height: 32rpx;}
.cuxiaopoint .f2 .img{width:32rpx;height:32rpx;}
.seckill_title{ width:100%;height:50rpx;position: absolute;z-index: 5;top: 702rpx;}
