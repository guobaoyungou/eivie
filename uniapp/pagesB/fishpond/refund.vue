...
<view class="container">
	<form @submit="formSubmit" @reset="formReset" report-submit="true">
		...
		<view class="form-item">
			...
			<view class="flex"><input name="money" type="digit" :value="totalprice" placeholder="请输入退款金额" disabled placeholder-style="color:#999;"></input></view>
		</view>
