...
<view>
	<block v-if="isload">
        ...
        <block v-if="info.sound_input_appid">
          <view class="form-item">
          	<view class="f1">友商编号：</view>
          	<view class="f2"><input type="text" name="client_id" :value="info.client_id" placeholder="请填写友商编号" placeholder-style="color:#888"></input></view>
          </view>	
          <view class="form-item">
          	<view class="f1">友商密钥：</view>
          	<view class="f2"><input type="text" name="client_secret" :value="info.client_secret" placeholder="请填写友商密钥" placeholder-style="color:#888"></input></view>
          </view>	
        </block>
        
        <view class="form-item">
        	<view class="f1">设备号：</view>
        	<view class="f2"><input type="text" name="device_sn" :value="info.device_sn" placeholder="请填写设备号" placeholder-style="color:#888"></input></view>
        </view>	
        <view class="form-item">
        	<view class="f1">消息密钥：</view>
        	<view class="f2"><input type="text" name="device_sign" :value="info.device_sign" placeholder="请填写友商密钥" placeholder-style="color:#888"></input></view>
        </view>	
...
export default {
  ...
  methods: {
		getdata:function(){
			...
			that.loading = true;
			app.get('ApiAdminSound/edit',{id:id}, function (res) {
				that.loading = false;
    ...
    subform: function (e) {
	  ...
	  that.subStatus = true
      var id = that.opt.id ? that.opt.id : '';
      app.post('ApiAdminSound/save', {id:id,info:formdata}, function (res) {
