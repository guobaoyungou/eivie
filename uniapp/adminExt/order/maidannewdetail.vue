...
export default {
  ...
  methods: {
		getdata: function (option) {
			var that = this;
			that.loading= true;
			app.get('ApiAdminMaidanNew/maidandetail', {id: that.opt.id}, function (res) {
				that.loading= false;
		...
		refundConfirm:function(){
			...
			app.showLoading('提交中...');
			app.post('ApiAdminMaidanNew/maidanrefund', {money:that.money,remark:that.remark,id:that.opt.id}, function(res) {
