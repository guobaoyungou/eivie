		...
		<block v-if="isload">
			<view class="box">
				<view class="box-title">
					...
					<view class="more" @tap="goto" data-url="maidannewlog"><text>全部记录</text><image class="icon" :src="pre_url+'/static/img/arrowright.png'"></image></view>
				</view>
	        ...
	        async init() {
	            ...
	            chart.setOption(this.option)
					...
					getdata: function () {
						var that = this;
						that.loading = true;
					  app.post('ApiAdminMaidanNew/index', {range: that.range,rangType:that.rangeType,month:that.month,start_date:that.start_date,end_date:that.end_date}, function (res) {
							that.loading = false;
