  ...
  methods: {
        ...
        getorderlist:function(loadmore){
            ...
            var keyword = that.keyword;
                ...
                that.nomore = false;
                that.loading = true;
            app.post('ApiXixie/dating', {st: st,pagenum: pagenum,keyword:keyword,longitude:that.longitude,latitude:that.latitude}, function (res) {
                console.log(res)
                that.loading = false;
                if(res.status==1){
