		...
		<view class="bottombar flex-row" :class="menuindex>-1?'tabbarbot':''" v-if="product.status==1">
			<view class="f1">
				...
				<view class="item" @tap="addfavorite">
					<image class="img" v-if="isfavorite" :src="pre_url+'/static/img/tabbar/shoucangselected.png'"/>
					<image class="img" v-else :src="pre_url+'/static/img/shoucang.png'"/>
