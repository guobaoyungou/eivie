	...
	<block v-if="isload">
		...
		<view class="form">
			<view class="form-item">
				<input type="text" class="input" placeholder="请输入昵称" placeholder-style="color:#BBBBBB;font-size:28rpx" name="nickname" value=""></input>
			</view>
		</view>
...
export default {
  ...
  methods: {
    formSubmit: function (e) {
      ...
      app.showLoading('提交中');
      app.post("ApiMy/setfield", {mid:mid,nickname:nickname}, function (data) {
