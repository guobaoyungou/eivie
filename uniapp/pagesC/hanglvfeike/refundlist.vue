  ...
  methods: {
    getdata: function (loadmore) {
      ...
      var st = that.st;
			...
			that.nomore = false;
			that.loading = true;
      app.post('ApiHanglvfeike/refundList', {st: st,pagenum: pagenum,orderid:that.opt.orderid,keyword:that.keyword}, function (res) {
				that.loading = false;
