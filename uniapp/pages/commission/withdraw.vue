...
<view class="container">
	...
	<form @submit="formSubmit">
		<view class="mymoney" :style="{background:t('color1')}">
			...
			<view class="f3" @tap="goto" data-url="commissionlog?st=1"><text>提现记录</text><text class="iconfont iconjiantou" style="font-size:20rpx"></text></view>
		</view>
		<view class="content2">
			...
			<view v-if="sysset.comwithdrawbl && sysset.comwithdrawbl!=100" style="width:94%;margin:0 3%;color:#8C8C8C;font-size:28rpx;margin-bottom:30rpx">提现金额的{{100-sysset.comwithdrawbl}}%将直接转到余额用于复购 </view>
		</view>
		...
		<view v-if="paytype=='支付宝'" style="width:100%;margin-top:40rpx;text-align:center;color:#999;display:flex;align-items:center;justify-content:center" @tap="goto" data-url="/pages/my/setaliaccount">设置支付宝账户<image src="/static/img/arrowright.png" style="width:30rpx;height:30rpx"/></view>
		<view v-if="paytype=='银行卡'" style="width:100%;margin-top:40rpx;text-align:center;color:#999;display:flex;align-items:center;justify-content:center" @tap="goto" data-url="/pages/my/setbankinfo">设置银行卡账户<image src="/static/img/arrowright.png" style="width:30rpx;height:30rpx"/></view>
	</form>
	</block>
