<template>
	<view>
		...
		<view class="car-number-container" v-if="showKeyPop1">
			<view class="plate-close" style="overflow: hidden;">
			  <text class="plate-close-btn" @click="closeKeyboard" style="float: left;margin-left: 15px;">取消</text>
			  <text class="plate-close-btn" @click="confirm" style="float: right;">完成</text>
			</view>
      ...
      confirm:function(){
        this.emitResult();
			...
			emitResult(){
				...
				this.$emit('inputResult', returnResult);
			}
		}
	};
</script>
