		...
		<view class="withdrawtype">
			...
			<view class="f2">
				...
				<label class="item" v-if="sysset.withdraw==1" @tap.stop="changeradio" data-paytype="余额">
					<view class="t1"><image class="img" :src="pre_url+'/static/img/withdraw-cash.png'"/>{{t('余额')}}</view>
				...
				<label class="item" v-if="sysset.withdraw_score==1 && sysset.withdraw_score_bili>0" @tap.stop="changeradio" data-paytype="积分">
					...
					<view class="radio" :style="paytype=='积分' ? 'background:'+t('color1')+';border:0' : ''"><image class="radio-img" :src="pre_url+'/static/img/checkd.png'"/></view>
				</label>
			</view>
		</view>
