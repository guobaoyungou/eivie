...
export default {
	...
	methods: {
		getdata:function(){
			var that = this;
			that.loading = true;
			app.post('ApiHealth/questionRecordLog', {rid:that.rid}, function (res) {
				that.loading = false;
				if (res.status == 1) {
...
.option_group .option{background:#f6f6f6; border-radius: 10rpx;margin-bottom: 20rpx;line-height: 40rpx;padding:14rpx 20rpx;}
