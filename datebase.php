...
CREATE TABLE `ddwx_admin_set` (
  ...
  `miandanst` tinyint(1) DEFAULT '0' COMMENT '2.6.7废弃 miandan_set.status',
  `miandan_wx` tinyint(1) NOT NULL DEFAULT '0' COMMENT '2.6.7废弃 miandan_set.query_status',
...
CREATE TABLE `ddwx_admin_set_sms` (
  ...
  `tmpl_send_coupon_st` tinyint(1) DEFAULT '1' COMMENT '发放优惠券通知开关',
  `tmpl_send_coupon`  varchar(64) DEFAULT NULL COMMENT '发放优惠券通知', 
  `tmpl_coupon_expired_st` tinyint(1) DEFAULT '1' COMMENT '优惠券快过期通知开关',
  `tmpl_coupon_expired`  varchar(64) DEFAULT NULL COMMENT '优惠券快过期通知通知',
  `tmpl_admin_operate_money_st` tinyint(1) DEFAULT '1' COMMENT '后台操作余额变更开关',
  `tmpl_admin_operate_money`  varchar(64) DEFAULT NULL COMMENT '后台操作余额变更',
  `tmpl_admin_recharge_money_st` tinyint(1) DEFAULT '1' COMMENT '余额充值通知开关',
  `tmpl_admin_recharge_money`  varchar(64) DEFAULT NULL COMMENT '余额充值通知',
  `tmpl_member_uplevel_st` tinyint(1) DEFAULT '1' COMMENT '后台操作余额变更开关',
  `tmpl_member_uplevel`  varchar(64) DEFAULT NULL COMMENT '后台操作余额变更',   
  `tmpl_member_uplevel_expired_st` tinyint(1) DEFAULT '1' COMMENT '后台操作余额变更开关',
  `tmpl_member_uplevel_expired`  varchar(64) DEFAULT NULL COMMENT '后台操作余额变更',
...
CREATE TABLE `ddwx_admin_setapp_alipay` (
  ...
  `pay_mode` tinyint(1) DEFAULT '1' COMMENT '支付模式 1:普通支付 2:直付通支付',
  `msid` varchar(20) DEFAULT NULL COMMENT '直付通二级商户id',
  PRIMARY KEY (`id`),
  UNIQUE KEY `aid` (`aid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ddwx_admin_upload` (
  ...
  `remote_type` varchar(20) NULL COMMENT '附件类型，aliyun,qiniu,tencent,local',
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`bid`) USING BTREE,
  KEY `uid` (`uid`) USING BTREE,
...
CREATE TABLE `ddwx_business_sysset` (
  ...
  `platform_fee_type` tinyint(1) DEFAULT '0' COMMENT '商家返款平台费率计算 0后计算1先计算',
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ddwx_coupon_order` (
  ...
  KEY `mid` (`mid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='优惠券购买订单';
...
CREATE TABLE `ddwx_form_order` (
  ...
  `parent2commission` decimal(11,2) DEFAULT '0.00',
  `parent3commission` decimal(11,2) DEFAULT '0.00',
  `is_send_commission` tinyint(1) DEFAULT '0' COMMENT '是否发放分销佣金 0未发放 1已发放 2退回',
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`bid`) USING BTREE,
  KEY `mid` (`mid`) USING BTREE,
...
CREATE TABLE `ddwx_freight` (
  ...
  `select_address_status` tinyint(1) DEFAULT '0' COMMENT '选择收货地址1开启0关闭',
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`bid`) USING BTREE,
...
CREATE TABLE `ddwx_member_level` (
  ...
  `apply_level_range` tinyint(1) NULL DEFAULT '1' COMMENT '申请等级：1所有等级，2小于等于推荐人等级，3小于推荐人等级',
...
CREATE TABLE `ddwx_payorder` (
  ...
  `wxpay_typeid` int(11) DEFAULT '0' COMMENT '微信支付模式 0 普通模式1  服务商模式2  二级商户3  随行付4  汇付天下斗拱5  银盛支付6 通联支付 7 微信收款码（定制pay_wx_native_h5）8 B2b模式',
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`),
  KEY `bid` (`bid`),
  KEY `mid` (`mid`),
...
CREATE TABLE `ddwx_shop_codelist` (
  ...
  KEY `bid` (`bid`) USING BTREE,
  KEY `proid` (`proid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='卡密商品的卡密';
...
CREATE TABLE `ddwx_shop_comment` (
  ...
  KEY `mid` (`mid`) USING BTREE,
  KEY `proid` (`proid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='商品评价';
...
CREATE TABLE `ddwx_shop_group` (
  ...
  KEY `status` (`status`) USING BTREE,
  KEY `from_id` (`from_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='商品分组';
...
CREATE TABLE `ddwx_shop_guige` (
  ...
  KEY `proid` (`proid`) USING BTREE,
  KEY `from_id` (`from_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='商品规格';
...
CREATE TABLE `ddwx_wx_tmplset` (
  ...
  `tmpl_orderpay` varchar(200) DEFAULT NULL COMMENT '支付成功通知',
  PRIMARY KEY (`id`),
  UNIQUE KEY `aid` (`aid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ddwx_shortvideo_category` (
  ...
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`aid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='短视频类型表';
...
CREATE TABLE `ddwx_yuyue_order` (
  ...
  `isticheng` tinyint(1) DEFAULT '0' COMMENT '是否服务提成：1是，0否',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `code` (`hexiao_code`) USING BTREE,
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`bid`) USING BTREE,
...
CREATE TABLE `ddwx_yuyue_set` (
  ...
  `yuyue_numtext` varchar(255) DEFAULT '预约详情页预约数量自定义文字',
  ...
  `finish_confirm` tinyint(1) DEFAULT '0' COMMENT '服务完成确认：1开启，0关闭',
  `confirm_type` tinyint(1) DEFAULT '1' COMMENT '确认方式：1会员确认，2商家确认',
  `autoconfirm` int(11) DEFAULT '1' COMMENT '自动确认天数',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `aid` (`aid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ddwx_kecheng_chapter` (
  ...
  KEY `bid` (`bid`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='课程章节';
...
CREATE TABLE `ddwx_kecheng_list` (
  ...
  `detail_text` text,
  `detail_pics` text,
  `showtj` varchar(100) DEFAULT '-1' COMMENT '显示等级',
  `gettj` varchar(255) DEFAULT '-1',
  `gettjurl` varchar(255) DEFAULT NULL,
  `gettjtip` varchar(255) DEFAULT NULL,
...
CREATE TABLE `ddwx_kecheng_order` (
  ...
  KEY `status` (`status`) USING BTREE,
  KEY `createtime` (`createtime`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='课程订单';
...
CREATE TABLE `ddwx_kecheng_record` (
  ...
  KEY `bid` (`bid`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='课程考试表';
...
CREATE TABLE `ddwx_kecheng_recordlog` (
  ...
  KEY `bid` (`bid`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='课程答题详情表';
...
CREATE TABLE `ddwx_kecheng_studylog` (
  ...
  KEY `status` (`status`) USING BTREE,
  KEY `createtime` (`createtime`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='学习log';
...
CREATE TABLE `ddwx_kecheng_tiku` (
  ...
  KEY `bid` (`bid`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='课程题库';
...
CREATE TABLE `ddwx_restaurant_shop_order` (
  ...
  `mids` varchar(255) DEFAULT NULL COMMENT '餐后付款，多人点餐需要的多个mid',
  `eattype` tinyint(1) DEFAULT '0' COMMENT '餐后付款 0先付后吃 1：先吃后付',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `code` (`hexiao_code`) USING BTREE,
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`bid`) USING BTREE,
...
CREATE TABLE `ddwx_restaurant_shop_order_goods` (
  ...
  `times` int(11) DEFAULT '0' COMMENT '第几次下单，餐后付款需要',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `aid` (`aid`) USING BTREE,
  KEY `bid` (`bid`) USING BTREE,
  KEY `mid` (`mid`) USING BTREE,
...
CREATE TABLE `ddwx_restaurant_shop_sysset` (
  ...
  `clean_table_status` tinyint(1) DEFAULT '0' COMMENT '餐前付款时，支付后是否清台',
  `status` tinyint(1) DEFAULT '1',
...
CREATE TABLE `ddwx_sxpay_fenzhang` (
  ...
  `ledger_type` tinyint(1) UNSIGNED NULL DEFAULT '1' COMMENT '分账方式：1同步，2异步',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ddwx_mp_tmplset_new` (
  ...
  `tmpl_yuyue_jiedan` varchar(64) DEFAULT NULL COMMENT '预约接单提醒',
  `tmpl_message_link` varchar(11) DEFAULT 'mp' COMMENT '模板消息链接 mp公众号 wx小程序',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `aid` (`aid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE  `ddwx_cashback_member` (
  ...
  KEY `mid` (`mid`),
  KEY `aid` (`aid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='购物返现活动参与人表';
...
CREATE TABLE `ddwx_cashback_member_log` (
  ...
  KEY `mid` (`mid`),
  KEY `aid` (`aid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='购物返现活动参与人表记录';
...
CREATE TABLE IF NOT EXISTS `ddwx_ali_wuliu` (
  ...
  `bid` int(11) DEFAULT '0',
	...
	KEY `type` (`type`),
	KEY `no` (`no`)
  ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='物流查询记录';
...
CREATE TABLE IF NOT EXISTS `ddwx_express_data` (
  ...
  INDEX `aid`(`aid`) USING BTREE,
  INDEX `bid`(`bid`) USING BTREE
  ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT '自定义快递数据';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT '订单号修改记录';
...
CREATE TABLE `ddwx_admin_wxicp` (
  ...
  `subject_other_materials` varchar(255) DEFAULT NULL COMMENT '主体其他附件',
  `subject_other_materials_media_id` varchar(100) DEFAULT NULL,
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `ddwx_member_score_scoreinlog` (
  ...
  `ordernum` varchar(60) NOT NULL DEFAULT '' COMMENT '订单号',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='支付流水';
...
CREATE TABLE `ddwx_wx_transfer_log` (
  ...
  `transfer_bill_no` varchar(60) DEFAULT NULL COMMENT '微信支付返回的转账单号',
  `message` text COMMENT '转账失败的原因',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='新版微信转账记录';

DROP TABLE IF EXISTS `ddwx_wechat_send_tmpl_data`;
CREATE TABLE `ddwx_wechat_send_tmpl_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL DEFAULT '0',
  `bid` int(11) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='微信模版消息统一发放数据表';

DROP TABLE IF EXISTS `ddwx_sxpay_paylog`;
CREATE TABLE `ddwx_sxpay_paylog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) DEFAULT NULL,
  `ordernum` varchar(60) DEFAULT NULL COMMENT '订单号',
  `tablename` varchar(60) DEFAULT NULL,
...
DROP TABLE IF EXISTS `ddwx_miandan_set`;
CREATE TABLE `ddwx_miandan_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) DEFAULT NULL,
  `bid` int(11) DEFAULT '0',
...
DROP TABLE IF EXISTS `ddwx_admin_set_custom`;
CREATE TABLE `ddwx_admin_set_custom` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`)
...
DROP TABLE IF EXISTS `ddwx_payorder_log`;
CREATE TABLE `ddwx_payorder_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ordernum` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ordernum` (`ordernum`)
...
DROP TABLE IF EXISTS `ddwx_mendian_withdrawlog`;
CREATE TABLE `ddwx_mendian_withdrawlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NULL DEFAULT NULL,
  ...
  `aliaccount` varchar(255) NULL DEFAULT NULL,
  `ordernum` varchar(60) NULL DEFAULT NULL,
  `paytype` varchar(60) NULL DEFAULT NULL,
  `status` tinyint(1) NULL DEFAULT 0,
  `createtime` int(11) NULL DEFAULT NULL,
  `bankname` varchar(255) NULL DEFAULT NULL,
  `bankcarduser` varchar(255) NULL DEFAULT NULL,
  `bankcardnum` varchar(255) NULL DEFAULT NULL,
  `paytime` int(11) NULL DEFAULT NULL,
  `paynum` varchar(60) NULL DEFAULT NULL,
  ...
  INDEX `bid`(`bid`) USING BTREE,
  INDEX `status`(`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='门店余额提现记录';

DROP TABLE IF EXISTS `ddwx_order_collect_reward`;
CREATE TABLE IF NOT EXISTS `ddwx_order_collect_reward` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) DEFAULT NULL,
  `bid` int(11) DEFAULT 0,
...
DROP TABLE IF EXISTS `ddwx_order_collect_reward_record`;
CREATE TABLE IF NOT EXISTS `ddwx_order_collect_reward_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) DEFAULT NULL,
  `bid` int(11) DEFAULT 0,
  `mid` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `ddwx_shortcut_menu`;
CREATE TABLE IF NOT EXISTS `ddwx_shortcut_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL,
  `bid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
