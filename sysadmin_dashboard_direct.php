...
if (!isset($_SESSION['sysadmin_admin_id'])) {
    header('Location: /sysadmin_login_direct.php');
    exit;
}
...
<body>
    <div class="header">
        ...
        <div class="user-info">
            ...
            <a href="/sysadmin_dashboard_direct.php?logout=1"><button class="logout-btn">退出登录</button></a>
        </div>
    </div>
    <div class="container">
        <div class="sidebar">
            <ul>
                <li><a href="/sysadmin_dashboard_direct.php">仪表盘</a></li>
                <li><a href="#">授权管理</a></li>
